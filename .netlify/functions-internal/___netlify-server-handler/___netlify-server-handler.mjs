...
} from '/var/task/Documents/Genesis Reloop Partner Proposal/.netlify/dist/run/handlers/request-context.cjs'
import { getTracer } from '/var/task/Documents/Genesis Reloop Partner Proposal/.netlify/dist/run/handlers/tracer.cjs'

process.chdir('/var/task/Documents/Genesis Reloop Partner Proposal')
  ...
  const handlerResponse = await runWithRequestContext(requestContext, () => {
    return tracer.withActiveSpan('Next.js Server Handler', async (span) => {
      span.setAttributes({
        ...
        monorepo: true,
        cwd: '/var/task/Documents/Genesis Reloop Partner Proposal',
      })
      if (!cachedHandler) {
        const { default: handler } = await import('/var/task/Documents/Genesis Reloop Partner Proposal/.netlify/dist/run/handlers/server.js')
